import * as tdg from "https://denopkg.com/shah/tsd-typed-data-gen@v0.5.3/mod.ts";
import type * as schema from "./content-schema.ts";

const content: schema.HomePage = {
  hero: [
    {
  ...
  highlights: [
    {
      hightlightTitle: "1,200+ Offerings in 50+ Topics",
      hightlightSubTitle:
        "Explore top digital health solutions, healthcare IT products and services, and medical devices.",
      goldenCollections: [
        {
          topicTitle: "Telemedicine",
          topicIcon: "images/01-icon-Telemedicine.png",
          topicUrl: "/topic/medigy-telemedicine/",
        },
        {
          topicTitle: "Remote Patient Monitoring",
          topicIcon: "images/02-ico-Remote-Patient-Monitoring.png",
          topicUrl: "topic/medigy-remote-patient-monitoring/",
        },
        {
          topicTitle: "Artificial Intelligence",
          topicIcon: "images/03-ico-Artificial-Intelligence.png",
          topicUrl: "/topic/frost-sullivan-artificial-intelligence/",
        },
        {
          topicTitle: "Machine Learning",
          topicIcon: "images/04-ico-Machine-Learning.png",
          topicUrl: "/topic/healthcare-it-news-machine-learning/",
        },
        {
          topicTitle: "Robotic Process Automation",
          topicIcon: "images/05-ico-Interoperability-Product-Engineering.png",
          topicUrl: "/topic/gartner-robotic-process-automation-rpa/",
        },
        {
          topicTitle: "Electronic Health Records",
          topicIcon: "images/06-ico-Electronic-Health-Records.png",
          topicUrl: "/topic/frost-sullivan-electronic-health-records-ehrs/",
        },
      ],
      objectiveSectionTitle: "Would Objective Advice Help?",
      objectiveSectionSubTitle:
        "At Medigy, users share their insights about products and trends, then we analyze these insights so that we can pinpoint the most impactful developments.",
      objectiveSectionDetails: [
        {
          title: "UNAVAILABILITY OF ACCURATE PRODUCT INSIGHTS",
          subTitle:
            "Current search for Digital Health Interoperability provides only very minimal information about products",
          icon: "/img/Picture1.png",
          backgroundColor: "#2ba7d1",
        },
        {
          title: "NOT POSSIBLE TO EVALUATE ALL RELATED PRODUCTS",
          subTitle:
            "Doing a product comparison is not easy in digital healthcare",
          icon: "/img/Picture2.png",
          backgroundColor: "#d13d4e",
        },
        {
          title: "WE USUALLY DO NOT GET A 360 VIEW OF THE PRODUCT",
          subTitle:
...
if (import.meta.main) {
  new tdg.CliArgsEmitter(import.meta.url).emitJSON(content);
}
